...
class Material(Base):
    ...
    category = Column(String(32), default="原材料", comment="大类: 主材/辅材/包装材料等")
    category_sub = Column(String(32), default="", comment="小类: 面布/底布/拉链等")
...
class SystemParam(Base):
    ...
    id = Column(Integer, primary_key=True, index=True, autoincrement=True)
    group_name = Column(String(32), nullable=False, index=True, comment="参数组: supplier_type/material_category/unit/payment_method/country/material_main_category/material_sub_category")
    ...
    parent_key = Column(String(32), default="", comment="所属上级参数(小类→大类)")
