...
class StockInOrder(Base):
    ...
    product_id = Column(Integer, ForeignKey("fd_product.id"), nullable=True, comment="产品（成品入库）")
    material_id = Column(Integer, ForeignKey("fd_material.id"), nullable=True, comment="材料（原料入库）")
