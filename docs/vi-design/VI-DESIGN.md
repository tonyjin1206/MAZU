...
**字体**: Inter / system-ui
**颜色**: 侧边栏用白色 #d8dce6，亮色背景用 #0c2d7a

---

## 3. 色彩系统

### 3.1 品牌主色 (Primary) — 暗色海洋蓝

| 色阶 | 色值 | 用途 |
|------|------|------|
| 50 | `#dbeafe` | 极浅蓝背景、hover 态 |
| 100 | `#bfdbfe` | 选中态、浅色标签 |
| 200 | `#93c5fd` | 边框、分割线 |
| 300 | `#60a5fa` | 禁用文字 |
| 400 | `#3b82f6` | 占位符、辅助蓝 |
| **500** | **`#1d4ed8`** | **基础色 — 按钮、链接、活动图标** |
| 600 | `#1e40af` | Hover 态（按钮悬浮） |
| 700 | `#1e3a5f` | 按下态（按钮激活） |
| 800 | `#0c2d7a` | 侧边栏底色、品牌深色 |
| 900 | `#081a45` | 最深蓝（标题/强调） |
...
| 名称 | 色值 | 用途 |
|------|------|------|
| sidebar-bg | `linear-gradient(180deg, #0c2d7a 0%, #123d8a 100%)` | 侧边栏背景 |
