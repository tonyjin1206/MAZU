...
const defaultColumns = [
  ...
  { prop: 'address', label: '供应商地址', minWidth: 180 , sortable: true },
  { prop: 'bank_name', label: '开户行', width: 140 , sortable: true },
  { prop: 'bank_account', label: '银行账号', width: 140 , sortable: true },
  { prop: 'default_tax_rate', label: '默认税率', width: 90, align: 'center' , sortable: true },
  { prop: 'rating', label: '评级', width: 110, align: 'center' , sortable: true },
  { prop: 'payment_terms', label: '付款条件', width: 100, sortable: true },
  { prop: 'account_period', label: '账期(天)', width: 90, sortable: true },
  { prop: 'tax_id', label: '税号', width: 140 , sortable: true },
