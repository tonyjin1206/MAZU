  ...
  <div>
    ...
    <el-card>
      <el-table :data="tableData" v-loading="loading" stripe border size="small" style="width: 100%">
        ...
        <el-table-column prop="created_at" label="保存日期" width="100" />
          ...
          <template #default="{ row }">
            <div style="display: flex; gap: 4px; white-space: nowrap">
              <template v-if="row.status === '待排产'">
                ...
                <el-button size="small" @click="openDetail(row, 'materials')">物料</el-button>
                <el-button size="small" @click="openDetail(row, 'processes')">工艺</el-button>
